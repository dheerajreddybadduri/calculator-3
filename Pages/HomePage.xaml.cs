...
public partial class HomePage : ContentPage
{
    ...
    void OnCalculate(object sender, EventArgs e)
    {
        if (currentState == 2)
        {
            ...
            App.historyViewModel.Add($"{firstNumber} {mathOperator} {secondNumber} = {this.resultText.Text}");


            //    expressions.Expression = currentCalculation;
            //   expressions.Result=result ;
            //   int SqlResult = 0;
            //     Init();

            //    MessagingCenter.Send(this,Expressions); 
